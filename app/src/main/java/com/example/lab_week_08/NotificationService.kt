...
class NotificationService : Service() {
    ...
    override fun onCreate() {
        ...
        val thread = HandlerThread("SecondThread").apply { start() }
    ...
    private fun createNotificationChannel(): String {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelId = "001"
            val channelName = "Second Worker Notification"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        serviceHandler.post {
            countDownFromTen(notificationBuilder)
            notifyCompletion(id)
    ...
    private fun countDownFromTen(builder: NotificationCompat.Builder) {
